                    ...
                    <form action="../../backend/cadastrarImovel.php" method="POST">
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <input type="text" name="cep" class="form-control rounded-pill text-muted" id="InputCep" aria-describedby="cep" placeholder="CEP">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <input type="text" name="rua" class="form-control rounded-pill" id="InputRua" aria-describedby="rua" placeholder="Rua">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <input type="text" name="bairro" class="form-control rounded-pill" id="InputBairro" aria-describedby="bairro" placeholder="Bairro">
